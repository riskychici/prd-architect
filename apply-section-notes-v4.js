...
/* ============================================================
   ...
   Catatan TIDAK tersedia untuk section Sampul & Footer
   Dokumen dan Informasi Proyek & Metadata.
   ============================================================ */
...
/* ============================================================
   ...
   Catatan biasa mengikuti warna dokumen (var --doc-accent).
   Catatan penting tetap merah.
   ============================================================ */
...
try {
  ...
  console.log('');
  console.log('Selesai.');
  console.log('Catatan biasa kini mengikuti warna dokumen.');
  console.log('Catatan penting tetap merah.');
  console.log('Section Sampul dan Informasi Proyek tidak lagi punya catatan.');
} catch (err) {
