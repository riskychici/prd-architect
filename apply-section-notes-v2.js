...
/* ============================================================
   FILE BARU: src/utils/sectionNotes.js
   ============================================================ */
...
/* ============================================================
   FILE BARU: src/components/editor/SectionNote.jsx
   ============================================================ */
...
export default function SectionNote(props) {
  ...
  return (
    <div className="mt-4 rounded-lg border border-dashed border-accent/40 bg-accent/5 p-3 space-y-2">
      <ToggleSwitch
        checked={enabled}
      ...
      {enabled && (
        <div className="space-y-1">
          ...
          <textarea
            ...
            rows="2"
            maxLength={500}
            placeholder="Tulis catatan internal, asumsi, TODO, atau reminder untuk tim. Catatan ini akan ikut preview, PDF, Markdown, dan JSON saat toggle aktif."
          ...
          <p className="text-[10px] text-mut">
            {value.length}/500. Catatan ikut preview, PDF, Markdown, dan JSON selama toggle aktif.
          </p>
        </div>
      )}
    </div>
...
/* ============================================================
   FILE BARU: src/components/preview/sections/NotePreview.jsx
   ============================================================ */
...
/* ============================================================
   OVERWRITE: src/components/editor/EditorSection.jsx
   ============================================================ */
...
/* ============================================================
   OVERWRITE: src/components/editor/EditorPanel.jsx
   ============================================================ */
...
/* ============================================================
   OVERWRITE: src/components/preview/PreviewDocument.jsx
   ============================================================ */
...
/* ============================================================
   OVERWRITE: src/utils/constants.js
   ============================================================ */
...
/* ============================================================
   OVERWRITE: src/utils/markdown.js
   ============================================================ */
...
/* ============================================================
   ...
   Membersihkan sisa patch versi lama jika pernah dipasang.
   ============================================================ */
...
function patchStore() {
  ...
  const newImportWithNotesEnabled = "import { DEFAULT_FIELDS, INITIAL_SIMPLE_EXTRAS, MAX_HISTORY, DEFAULT_SECTION_NOTES, DEFAULT_SECTION_NOTES_ENABLED } from '../utils/constants';";

  if (content.includes('DEFAULT_SECTION_NOTES') && !content.includes('DEFAULT_SECTION_NOTES_ENABLED')) {
...
try {
  ...
  console.log('');
  console.log('Selesai.');
  console.log('Sekarang setiap section punya toggle catatan sendiri.');
  console.log('Catatan yang aktif akan muncul di preview, PDF, Markdown, dan JSON.');
} catch (err) {
